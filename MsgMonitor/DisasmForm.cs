    ...
    public partial class DisasmForm : Form
    {
        ...
        public DisasmForm(WrittenMemoryInfo wmInfo, bool extend = false)
        {
            ...
            if (extend)
            {
                ...
                AddressUpDown.Minimum = 0;
                AddressUpDown.Maximum = 0xffffffffffffffff;
        ...
        {
            if (extend) ReadProcessMemory(hProcess, (IntPtr)AddressUpDown.Value, wmInfo.ByteArray, wmInfo.ByteArray.Length, 0);
            var disasm = new Disassembler(wmInfo.ByteArray, ArchitectureMode.x86_32, (ulong)AddressUpDown.Value, true);
